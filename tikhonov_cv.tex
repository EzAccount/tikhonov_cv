...
\begin{document}
	...
	2017 &\textbf{Term project:} Light scattering on nanoparticles\\
	   ...
	   &\end{tabular}\\
		...
		&\\
		\Large{Publications}  
		&\textbf{Exact solution for a spin chain with quenched disorder. }\\& Tikhonov Mikhail and Gennadiy Koval. \textit{in preporation} \\
		&\textbf{Parameter symmetry in perturbed GUE corners process}\\&\textbf{and reflected drifted Brownian motions}\\& Leonid Petrov and Tikhonov Mikhail. arXiv:1912.08671\\
